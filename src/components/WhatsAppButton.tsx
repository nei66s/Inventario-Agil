...
export function WhatsAppButton() {
    const phoneNumber = '5511999999999'; // Número fictício do USER (Admin Black Tower X)
    ...
    return (
        <a
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-2xl shadow-emerald-500/40 transition-all hover:scale-110 active:scale-95 group"
